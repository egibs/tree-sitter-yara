...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [299] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_hex_string_repeat1, 2, 0, 0), SHIFT_REPEAT(149),
  [302] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_hex_string_repeat1, 2, 0, 0), SHIFT_REPEAT(117),
  ...
  [368] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_regex_string_content, 1, 0, 0),
  ...
  [380] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_meta_definition, 3, 0, 10),
  [382] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_meta_definition, 3, 0, 10),
  [384] = {.entry = {.count = 1, .reusable = true}}, SHIFT(93),
  [386] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_single_quoted_string_repeat1, 2, 0, 0),
  [388] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_single_quoted_string_repeat1, 2, 0, 0), SHIFT_REPEAT(98),
  ...
  [403] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_regex_string_content_repeat1, 2, 0, 0),
  ...
  [421] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_definition, 4, 0, 11),
  ...
  [435] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_body, 2, 0, 0),
  ...
  [447] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_tag_list_repeat1, 2, 0, 0), SHIFT_REPEAT(150),
  [450] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tag_list_repeat1, 2, 0, 0), SHIFT_REPEAT(189),
  ...
  [465] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_set_repeat1, 2, 0, 0),
  [467] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_set_repeat1, 2, 0, 0), SHIFT_REPEAT(147),
  [470] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_hex_alt_sequence_repeat1, 2, 0, 0), SHIFT_REPEAT(151),
  [473] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_hex_alt_sequence_repeat1, 2, 0, 0),
  [475] = {.entry = {.count = 1, .reusable = true}}, SHIFT(67),
  [477] = {.entry = {.count = 1, .reusable = true}}, SHIFT(189),
  [479] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_tag_list_repeat1, 2, 0, 3),
  [481] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_tag_list_repeat1, 2, 0, 3),
  [483] = {.entry = {.count = 1, .reusable = true}}, SHIFT(136),
  [485] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag_list, 3, 0, 0),
  ...
  [495] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_tag_list_repeat1, 1, 0, 1),
  [497] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_tag_list_repeat1, 1, 0, 1),
  ...
  [529] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quantifier, 1, 0, 0),
  ...
  [539] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_body, 3, 0, 0),
  ...
  [557] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range, 5, 0, 0),
  [559] = {.entry = {.count = 1, .reusable = true}},  ACCEPT_INPUT(),
  [561] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quantifier, 2, 0, 0),
